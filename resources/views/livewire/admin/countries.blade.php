<div>
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        @if (session()->has('success'))
            <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
                ...
                <span>Add shippings &RightArrow;</span>
            </a>
        @endif
        ...
        <form wire:submit.prevent="storeCountry" method="POST" class="flex justify-around ml-4 mt-2 flex-1 lg:mr-32">
            ...
            <input type="text" wire:model.live="code"
                class="block mr-2 text-sm dark:text-gray-300 border-0 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                placeholder="Code" style="width: 105px" required />
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <flux:modal.trigger name="edit-country">
                                        <button
                                            wire:click="$dispatch('edit-country', { mode: 'edit', country: '{{ $country->slug }}' })"
                                    ...
                                    <flux:modal.trigger name="delete-country">
                                        <button wire:click="$dispatch('delete-country', {id: {{ $country->id}}})"
                                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                            aria-label="Delete">
                                            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
    ...
    <flux:modal name="edit-country" class="w-full bg-white rounded-t-lg dark:bg-gray-800  sm:rounded-lg sm:max-w-xl">
        <div>
            <div class="text-center mt-8 mb-2">
                <flux:text class="text-gray-700 dark:text-gray-400">Edit country
                </flux:text>
            </div>

            <div class="mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form method="POST" id="update_country" wire:submit.prevent="updateCountry">
            ...
            <div class="flex">
                <flux:spacer />
                <button type="submit" form="update_country"
    ...
    <flux:modal name="delete-country" class="bg-white rounded-t-lg dark:bg-gray-800">
        <div>
            <div class="text-center mt-8 mb-2">
                <flux:text class="text-gray-700 dark:text-gray-400">Delete country?
                </flux:text>
            </div>

            <div class="mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <span class="text-sm text-gray-600 dark:text-gray-400">You're about to delete this country</span>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    This will affect food under this country</p>
            </div>
            ...
            <div class="flex">
                ...
                <button wire:click="deleteCountry"
