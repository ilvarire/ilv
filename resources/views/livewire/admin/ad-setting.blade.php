<div x-data="{ showModal: false, action: '', adId: null }" x-on:modal-close.window="showModal = false">
            ...
            <table class="w-full whitespace-no-wrap">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-3">Sub Text</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    <div>
                                        <p class="font-semibold"> {{$ad->main}} </p>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <button wire:click="edit({{ $ad->id }})"
                                        @click="action = 'edit'; adId = {{ $ad->id }}; showModal = true"
                ...
                <template x-if="action === 'edit'">
                    <div>
                        ...
                        <div class="grid gap-6 mb-6 mt-4 md:grid-cols-2 xl:grid-cols-4">
                            @if ($existingAdImage)
                                <img src="{{ asset('storage/' . $existingAdImage) }}" alt="" class="rounded-lg"
                                    loading="lazy" />
                            @endif
                        </div>
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <form method="POST" wire:submit.prevent="updateAd" id="update_ad">
                                @csrf
                                ...
                                <label class="block text-sm mb-2">
                                    ...
                                    <input type="text" wire:model.defer="sub_text"
                                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                                ...
                                <label class="block text-sm mb-2">
                                    ...
                                    <input type="file" accept="image/*" wire:model="adImage"
                                        value="{{ old('adImage') }}"
                                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input"
                                ...
                                @if ($adImage)
                                    <div class="grid gap-6 mb-6 mt-4 md:grid-cols-2 xl:grid-cols-4">
                                        <img src="{{ $adImage->temporaryUrl() }}" alt="img" class="rounded-lg">
                                    </div>
                                @endif
                            </form>
                        </div>
                        ...
                        <footer
                            ...
                            <button type="submit" form="update_ad"
