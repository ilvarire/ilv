        ...
        <div class="relative w-full h-auto" x-cloak x-data="{
            ...
            <form method="POST" action="{{ route('two-factor.login.store') }}">
                ...
                <div class="space-y-5 text-center">
                    ...
                    <div x-show="showRecoveryInput">
                        <div class="my-5">
                            <flux:input style="border-radius: 20px;" type="text" name="recovery_code"
                                x-ref="recovery_code" x-bind:required="showRecoveryInput" autocomplete="one-time-code"
                    ...
                    <flux:button style="border-radius: 20px; background: #3743ed; color: #fff;" variant="primary"
