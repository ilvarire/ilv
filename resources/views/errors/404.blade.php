        ...
        <div class="error-icon m-b-24">
            <svg class="bounce" width="112" height="112" viewBox="0 0 112 112">
                ...
                <text x="56" y="72" text-anchor="middle" fill="#717fe0" font-size="48"
                    font-family="Montserrat,Arial,sans-serif">404</text>
            </svg>
        </div>
        <h1 class="ltext-103 cl1 m-b-10">Page Not Found</h1>
        <p class="stext-103 cl3 m-b-24">Sorry, the page you are looking for does not exist or has moved.</p>
